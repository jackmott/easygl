...
let lightingShader = CreateAndLinkProgram("shaders/basic_lighting.vert","shaders/basic_lighting.frag")
let lampShader = CreateAndLinkProgram("shaders/basic_lighting_lamp.vert","shaders/basic_lighting_lamp.frag")
