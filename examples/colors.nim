...
let lightingShader = CreateAndLinkProgram("shaders/colors.vert","shaders/colors.frag")
let lampShader = CreateAndLinkProgram("shaders/colors.vert","shaders/colors_lamp.frag")
