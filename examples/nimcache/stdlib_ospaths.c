...
static N_NIMCALL(void, TM_jvWQYw9bcuYhftfPX2ynPeg_40)(void);
...
extern tyProc_9bXer9a4ps9aSGctILcxWReVw Dl_148830_;
extern tyProc_aO673xGTLLxou7P7GxoCXA Dl_148835_;
extern tyProc_im9buRnIvptJfzdASYMEbBA Dl_149001_;
...
extern tyProc_9cu0cWy2jNXKVhds9cs4T9a9cA Dl_149632_;
extern tyProc_hayl9b1HhJokJ1Zo9ctoglPg Dl_149634_;
extern tyProc_IwsYs9blTXXmAlfsBWq604w Dl_149018_;
...
STRING_LITERAL(TM_jvWQYw9bcuYhftfPX2ynPeg_38, "unknown OS error", 16);
STRING_LITERAL(TM_jvWQYw9bcuYhftfPX2ynPeg_39, "\015\012Additional info: ", 19);
STRING_LITERAL(TM_jvWQYw9bcuYhftfPX2ynPeg_44, "USERPROFILE", 11);
STRING_LITERAL(TM_jvWQYw9bcuYhftfPX2ynPeg_45, "APPDATA", 7);
STRING_LITERAL(TM_jvWQYw9bcuYhftfPX2ynPeg_46, "TEMP", 4);
...
N_NIMCALL(NimStringDesc*, nososErrorMsg)(void) {
	...
	nimln_(25, "oserr.nim");
	{
		...
		nimln_(28, "oserr.nim");
		{
			...
			nimln_(28, "oserr.nim");
			T7_ = (NI32)0;
			T7_ = Dl_148835_(((NI32) 5119), NIM_NIL, err, ((NI32) 0), ((void*) (&msgbuf)), ((NI32) 0), NIM_NIL);
...
N_NOINLINE(void, nosraiseOSError)(NimStringDesc* msg) {
	...
	nimln_(52, "oserr.nim");
	{
		...
		LA7_: ;
		{
			...
			T11_ = (*e).Sup.Sup.message; (*e).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_38));
...
N_NIMCALL(NimStringDesc*, osErrorMsg_yWvWz5V6Ib7QshcAbOiDeQ)(NI32 errorCode) {
	...
	nimln_(80, "oserr.nim");
	{
		...
		nimln_(83, "oserr.nim");
		{
			...
			nimln_(83, "oserr.nim");
			T7_ = (NI32)0;
			T7_ = Dl_148835_(((NI32) 4864), NIM_NIL, errorCode, ((NI32) 0), ((void*) (&msgbuf)), ((NI32) 0), NIM_NIL);
			if (!!((T7_ == ((NI32) 0)))) goto LA8_;
			nimln_(85, "oserr.nim");
			result = dollar__D2o4ABrO3iHTudww2CqX4w(msgbuf);
			nimln_(86, "oserr.nim");
...
appendString(T6_, ((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_39));
appendString(T6_, additionalInfo);
	...
	nimln_(111, "oserr.nim");
	{
		...
		T12_ = (NimStringDesc*)0;
		T12_ = (*e).Sup.Sup.message; (*e).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_38));
...
{	nimln_(33, "osenv.nim");
	{
		...
		LA7_: ;
		{
			...
			while (1) {
				...
				NI T12_;
				NimStringDesc* T13_;
				NI TM_jvWQYw9bcuYhftfPX2ynPeg_41;
				nimln_(41, "osenv.nim");
				...
				if (T13_) nimGCunrefNoCycle(T13_);
				nimln_(43, "osenv.nim");
				TM_jvWQYw9bcuYhftfPX2ynPeg_41 = addInt(((NI) (eend)), ((NI) 2));
				e = ((NI16*) ((NI)(TM_jvWQYw9bcuYhftfPX2ynPeg_41)));
				nimln_(44, "osenv.nim");
				{
...
appendChar(T1_, 61);
	temp = T1_;
	{
		...
		res = ((NI) 0);
		{
			nimln_(1987, "system.nim");
			while (1) {
				NI TM_jvWQYw9bcuYhftfPX2ynPeg_42;
				...
				LA9_: ;
				nimln_(1989, "system.nim");
				TM_jvWQYw9bcuYhftfPX2ynPeg_42 = addInt(res, ((NI) 1));
				res = (NI)(TM_jvWQYw9bcuYhftfPX2ynPeg_42);
			} LA5: ;
		}
	}
	nimln_(95, "osenv.nim");
...
{	result = (NimStringDesc*)0;
	...
	nimln_(107, "osenv.nim");
	{
		...
		TM_jvWQYw9bcuYhftfPX2ynPeg_43 = addInt(T5_, ((NI) 1));
		result = copyStr(environment_rnCB7Cc69bd2mlM49cn9czO2Q->data[i], (NI)(TM_jvWQYw9bcuYhftfPX2ynPeg_43));
		goto BeforeRet_;
	}
	goto LA1_;
	LA3_: ;
...
{	result = (NimStringDesc*)0;
	...
	T1_ = (NimStringDesc*)0;
	T2_ = (NimStringDesc*)0;
	T2_ = getEnv_rVXof6qIUKJ3J9cw79conT2g(((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_44));
	T1_ = rawNewString(T2_->Sup.len + 1);
appendString(T1_, T2_);
appendString(T1_, ((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_30));
	result = T1_;
	goto BeforeRet_;
	}BeforeRet_: ;
	popFrame();
...
{	result = (NimStringDesc*)0;
	...
	T1_ = (NimStringDesc*)0;
	T2_ = (NimStringDesc*)0;
	T2_ = getEnv_rVXof6qIUKJ3J9cw79conT2g(((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_45));
	T1_ = rawNewString(T2_->Sup.len + 1);
appendString(T1_, T2_);
appendString(T1_, ((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_30));
	result = T1_;
...
{	result = (NimStringDesc*)0;
	...
	T1_ = (NimStringDesc*)0;
	T2_ = (NimStringDesc*)0;
	T2_ = getEnv_rVXof6qIUKJ3J9cw79conT2g(((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_46));
	T1_ = rawNewString(T2_->Sup.len + 1);
appendString(T1_, T2_);
appendString(T1_, ((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_30));
	result = T1_;
...
nimRegisterGlobalMarker(TM_jvWQYw9bcuYhftfPX2ynPeg_40);
	popFrame();
}
